...
class ScheduleTest extends \Codeception\Test\Unit
{
    ...
    public function testFindOne()
    {
        ...
        expect_not(Schedule::findOne(10000));
    }
    ...
    public function testFindOneDeleted()
    {
        ...
        expect_not(Schedule::findOneDeleted(10000));
    }
    public function testFindAll()
    {
        $this->assertCount(7549, Schedule::findAll());
    }
    
    public function testFindAllDeleted()
    {
        $this->assertCount(494, Schedule::findAllDeleted());
    }
    ...
    public function testDelete()
    {
        ...
        $this->assertCount(7548, Schedule::findAll());
        $this->assertCount(495, Schedule::findAllDeleted());
