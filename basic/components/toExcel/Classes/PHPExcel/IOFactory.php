...
use app\components\toExcel\Classes\PHPExcel\Reader\PHPExcel_Reader_Excel2007;
use app\components\toExcel\Classes\PHPExcel\Writer\PHPExcel_Writer_Excel2007;
	...
	public static function createWriter(PHPExcel $phpExcel, $writerType = '') {
		...
		foreach (self::$_searchLocations as $searchLocation) {
			if ($searchLocation['type'] == $searchType) {
				...
				$instance = new Writer\PHPExcel_Writer_Excel2007($phpExcel);
	...
	public static function createReader($readerType = '') {
		...
		foreach (self::$_searchLocations as $searchLocation) {
			if ($searchLocation['type'] == $searchType) {
				...
				$instance = new Reader\PHPExcel_Reader_Excel2007();
